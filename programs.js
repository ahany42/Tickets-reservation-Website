...
//   gallery[1].innerHTML = '<img class="imgright" src="/main-assets/Spring.png"><div class="gallerytxt">Our CEO, Ahmed Samir, was welcoming everyone to the company and proceeded by letting them know about the work procedure.</div>'
//   gallery[3].innerHTML = '<img class="imgright" src="/main-assets/faith"><div class="gallerytxt">The academy is not only all about work;yet, it is a whole experience where you get to build a community and have a blast</div>'
// }else{
//   gallery[1].innerHTML = '<div class="gallerytxt">Our CEO, Ahmed Samir, was welcoming everyone to the company and proceeded by letting them know about the work procedure.</div><img class="imgright" src="/main-assets/faith">'
//   gallery[3].innerHTML = '<div class="gallerytxt">The academy is not only all about work;yet, it is a whole experience where you get to build a community and have a blast</div><img class="imgright" src="/main-assets/faith">'
// }
